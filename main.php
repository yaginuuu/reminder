...
try{
    ...
    $chat_work_tasks_fomatter = new FormatTextToRemindForChatWork($chat_work_tasks);
    $chat_work_formatted_messages = $chat_work_tasks_fomatter->getFormatMessageText();

    array_walk($chat_work_formatted_messages,
